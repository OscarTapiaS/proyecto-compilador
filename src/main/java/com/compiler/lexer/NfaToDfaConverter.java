...
public class NfaToDfaConverter {
     ...
     */
	private static void processStates(Queue<DfaState> estadosPorProcesar, List<DfaState> estadosDfa, Set<Character> alphabet) {
     ...
     *  @param estadosPorProcesar The queue of DFA states to process.
     */
	private static void handleTransition(DfaState estadoActual, Character symbol, List<DfaState> estadosDfa, Queue<DfaState> estadosPorProcesar) {
